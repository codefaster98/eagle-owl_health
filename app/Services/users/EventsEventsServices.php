...
class EventsEventsServices
{
    ...
    public function show($language,$id)
    {
        if ($language == 'ar') {
            ...
            }])->select('id', 'title_ar as title', 'shortDescription_ar as description', 'image','price')->find($id);
            return $event;
        } else {
            $event = EventsEventsM::with(['speakers' => function ($query) {
            ...
            }])->select('id', 'title_en as title', 'shortDescription_en as description','longDescription_en as description', 'image','price')->find($id);
            return $event;
